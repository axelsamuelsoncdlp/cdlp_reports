    ...
    return (
      <div className="space-y-8">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h2 className="text-lg font-semibold text-gray-900">Loading New Customers per Country</h2>
            <p className="text-sm text-gray-600">Processing new customer data by country...</p>
          </div>
        </div>
